...
export default function App() {
  ...
  const pages = {
    ...
    templates: <Templates drafts={drafts} setDrafts={setDrafts} apiKey={apiKey} posts={posts} />,
    checklist: <Checklist checklists={checklists} setChecklists={setChecklists} />,
    kanban: <Kanban kanban={kanban} setKanban={setKanban} apiKey={apiKey} posts={posts} />,
    workflow: <Workflow />,
